...
const App = () => {
  ...
  return (
    <LinearGradient
      ...
      <Image
        source={require('../../assets/player/images/left.png')}
        style={{
          width: 24,
          height: 24,
          tintColor: 'white',
      ...
      <View
        ...
        <View
          ...
          <Image
            source={require('../../assets/player/images/search2.png')}
      ...
      <View style={{flexDirection: 'row', paddingLeft: 20, marginTop: 20}}>
        <Image
          source={require('../../assets/player/images/spotify.png')}
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Image
            source={require('../../assets/player/images/plus.png')}
            style={{width: 18, height: 18, tintColor: '#bababa'}}
          />
          <Image
            source={require('../../assets/player/images/arrow-down.png')}
            style={{
              width: 18,
              height: 18,
              tintColor: '#bababa',
          ...
          />
          <Image
            source={require('../../assets/player/images/option.png')}
            style={{
              width: 18,
              height: 18,
              tintColor: '#bababa',
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Image
            source={require('../../assets/player/images/suffle.png')}
          ...
          <TouchableOpacity
            ...
            {State.Playing == playbackState ? (
              <Image
                source={require('../../assets/player/images/pause.png')}
                style={{
                  width: 40,
                  height: 40,
                  marginLeft: 20,
              ...
              <Image
                source={require('../../assets/player/images/play-button.png')}
                style={{
                  width: 50,
                  height: 50,
                  marginLeft: 20,
            ...
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                {index == currentIndex && State.Playing == playbackState && (
                  <Image
                    source={require('../../assets/player/images/playing.png')}
                    style={{
                      width: 18,
                      height: 18,
                      tintColor: 'white',
      ...
      <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          <Image
            source={
              State.Playing == playbackState
                ? require('../../assets/player/images/pause2.png')
                : require('../../assets/player/images/play.png')
            }
