...
import { Alert, AlertButton, Dimensions, Image, Linking, StyleSheet, View } from 'react-native'
import {
...
import { CONTENT_SPACING, CONTROL_BUTTON_SIZE, SAFE_AREA_PADDING, SCREEN_HEIGHT, SCREEN_WIDTH } from './Constants'
...
const CodeScannerPage = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Back Button */}
      <PressableOpacity style={styles.backButton} onPress={() => navigation.replace('Request')}>
        <IonIcon name="close" color="white" size={35} />
      </PressableOpacity>
...
function setIsCameraInitialized(arg0: boolean) {
